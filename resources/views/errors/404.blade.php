...
<head>
  ...
  <title>Juvenile Diabetes Monitor</title>
  <!-- plugins:css -->
        ...
        <div class="row flex-grow">
          <div class="col-lg-7 mx-auto text-white">
            ...
            <div class="row mt-5">
              ...
              <a class="text-white font-weight-medium" href="{{ url('/validate-login') }}">Back to home</a>
              </div>
            </div>
            <div class="row mt-5">
              <div class="col-12 mt-xl-2">
                <p class="text-white font-weight-medium text-center">Copyright © <?php echo date('Y'); ?>
                  Juvenile Diabetes Monitor. All rights reserved.</span></p>
              </div>
            </div>
          </div>
        </div>
